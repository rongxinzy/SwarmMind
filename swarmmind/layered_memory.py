...
class LayeredMemory:
    ...
    def read(self, key: str, ctx: MemoryContext) -> MemoryEntry | None:
        ...
        for scope in ctx.visible_scopes:
            ...
            try:
                ...
                # nosec: B608 - safe, where clause is internally generated by _scope_where
                cursor.execute(
    ...
    def read_all(
        ...
        try:
            ...
            sql = f"SELECT * FROM memory_entries WHERE layer IN ({placeholders})"  # nosec: B608 - safe parameterized query with ? placeholders
    ...
    def promote_session(
        ...
        try:
            ...
            if key_filter:
                ...
                cursor.execute(
                    # nosec: B608 - safe parameterized query with ? placeholders
                    f"""
