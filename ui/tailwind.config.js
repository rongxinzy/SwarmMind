...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        brutal: "0 1px 2px rgba(17, 17, 17, 0.04)",
        "brutal-sm": "0 1px 2px rgba(17, 17, 17, 0.04)",
        "brutal-primary": "0 1px 2px rgba(17, 17, 17, 0.04)",
        glow: "0 0 0 4px rgba(220, 235, 255, 0.8)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
